...
var _Customers = _interopRequireDefault(require("../../../customers/typeorm/entities/Customers"));
...
let Order = (_dec = (0, _typeorm.Entity)('orders'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.ManyToOne)(() => _Customers.default, customer => customer.id), _dec5 = (0, _typeorm.JoinColumn)({
  name: 'customer_id'
}), _dec6 = Reflect.metadata("design:type", typeof _Customers.default === "undefined" ? Object : _Customers.default), _dec7 = (0, _typeorm.OneToMany)(() => _OrdersProducts.default, order_products => order_products.order, {
  cascade: true
